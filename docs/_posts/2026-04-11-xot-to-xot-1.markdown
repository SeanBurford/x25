...
The "Not yet implemented" seems to be due to Linux setting the Q bit on a packet to xotpad.  We won't worry about that for now.
...
This allows us to run a single xotd to manage multiple TUN devices, we can probably use this instead of running multiple xotd instances.
